...
path <- "~/Desktop/GIT_REPOSITORIES/BIOL3100_Exams/Exam_1/data/COVID-19/csse_covid_19_data/csse_covid_19_daily_reports_us"
outpath <- "~/Desktop/GIT_REPOSITORIES/BIOL3100_Exams/Exam_1/data/cleaned_covid_data.csv"
